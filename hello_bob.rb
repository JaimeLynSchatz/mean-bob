...
puts "*******************************************************************************"
listen
puts ">> I'LL GET YOU THROUGH THE ROUGH PATCHES."
type_string("""I've started finding alternative childcare. ADA starts a little too early for moms who need to drop their kiddos off at school.""")
type_string("""I'm also investigating funding sources so I can afford to study full time for a year.""")
...
type_string("""As a kid, I wondered how the ATM at the grocery store worked. I wondered why your car needed you to flip the turn signal and it didn't tell *you* when to turn.""") 
sleep 0.3
skip_line 1
puts ">> THAT MUST HAVE BEEN BEFORE IN-DASH NAVIGATION"
skip_line 1
sleep 0.2
type_string("""It was.""")
type_string("""Anyway, I wanted my own Threepio (and later, my own Edgar or Data or Yod...) It took **years** for me to realize that I didn't have to be Bill Gates or Noonian Soong or any of those GUYS to write software.""")
type_string("""So, for a couple of years now, I've been studying part time on Codecademy and Udacity and the public parts of the ADA curriculum and everything else I can get my hands on.""")
