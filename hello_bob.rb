...
skip_line 1
    ...
    type_string("""ve started finding alternative childcare. ADA starts a little too early for moms who need to drop their kiddos off at school.""")
    ...
    sleep 0.3
    skip_line 1
    type_string("""That was way before in-dash navigation.""")
    skip_line 1
    sleep 0.2
